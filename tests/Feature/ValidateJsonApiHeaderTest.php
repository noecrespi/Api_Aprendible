...
class ValidateJsonApiHeaderTest extends TestCase
{
     ...
     * @test
     */
    // header content type tiene que estar presentes en todas las peticiones post
     ...
     * @test
     */
    // header content type tiene que estar presentes en todas las peticiones patch
     ...
     * @test
     */
    // header content type tiene que estar presentes en el caso que tenga datos
     ...
     * @test
     */
    //  si la respuesta es vacia el content-type no debe estar presente
